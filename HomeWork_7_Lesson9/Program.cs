...
namespace Lesson
{
    ...
    public class Program
    {
        ...
        public static void Main()
        {
            ...
            Console.WriteLine($"создаем массив длиной в 30 значений , и заполняем его при помощи Random() с диппазоном числе от 10 до 99.");
            ...
            showArray(randomArray); // Выводим отсортированный массив 
                Console.WriteLine($"Количество проходов по циклу: {counter}");
